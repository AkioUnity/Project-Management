var jQEngager, notify_handler, ms = Date.now(), currVersion = ms, scripts = document.getElementsByTagName("script"),
    index = scripts.length - 1;
currScript = scripts[index];
var lsRepUrl = currScript.getAttribute("data-source_path"), autoReconnectInterval = 5000,
    initVideoLoader = function () {
        var a = function () {
            ...
            ({lsRepUrl: lsRepUrl, lang: svConfigs.smartVideoLanguage});
            ...
            svConfigs.iceServers.requirePass ? $.ajax({
                ...
                data: {type: "getpassphrase"}
                    ...
                    a && (svConfigs.iceServers.passPhrase = a, loadScript(svConfigs.appWss + "socket.io/socket.io.js", b))
                }).fail(function () {
