=== PMChat Video Chat Live Video Chat ===
...
PMChat Video Chat Live Video chat plugin for WordPress that allows visitors to establish live video chat in the browser without download.

== Description ==

The plugin is developed by PMChat Video Chat Inc., whose mission is to bring face-to-face communication online. Host your own live video/chat sessions, interact with your visitors and boost your sales.

PMChat Video Chat plugin lets you embed ‘Video Chat' button, online and offline forms on your website to let your website visitors click to start a video or regular chat with you directly. Visitors can also make an audio or video call directly from their web browser.

Before installing this plugin make sure you have installed PMChat Video Chat on your server. You can acquire it from CodeCanyon.

You can use PMChat Video Chat to:
...
The PMChat Video Chat Plugin gives you the option to customize your button with a text of your own choice. Get exactly the look and feel you want.

= Options =

The following options are customizable:

* message on the PMChat Video Chat button
...
[https://codecanyon.net/item/PMChat-video-chat/23122332](https://codecanyon.net/item/PMChat-video-chat/23122332 "https://codecanyon.net/item/PMChat-video-chat/23122332")

== Frequently Asked Questions ==

= What browser does PMChat Video Chat support? =

PMChat Video Chat is supported on all major browsers:
...
= What devices does PMChat Video Chat work with? =
...
PMChat Video Chat is a hosted, cloud based live video communication service. It does not require you to install any additional hardware or software. Simply configure the plugin to suit your preferences and you should be up, and running in minutes.
...
How should I setup PMChat Video Chat's Wordpress live video button for my site?
...
2/ Once you active the plugin on your left panel you will be able to see PMChat Video Chat's plugin settings. Click on them.
...
d/ room ID - (optional) this is the private roomId of the agent. When you generate a link, this is the string after room attribute. For example if the link is something like this: pages/room.html?room=2bsdhnz0lvs&isAdmin=1 - copy/paste 2bsdhnz0lvs in the shortcode, [PMChat_widget roomId="2bsdhnz0lvs"];

e/ names - (optional) names of the agent, that is receiving the calls. You can set this in the Settings page, or in the shortcode as a parameter, for example [PMChat_widget names="NAME_OF_AGENT"] where NAME_OF_AGENT should be the actual name.
