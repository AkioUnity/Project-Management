...
/*
  Plugin Name: PMChat Video Chat
  Plugin URI: https://www.new-dev.com/page/ident/live_smart_video_chat
  Description: PMChat Widget HTML and JavaScript. It can be addded in a page using the tag [PMChat_widget] or just call do_action('PMChat_widget');
  Version: 1.1
  Author: PMChat
